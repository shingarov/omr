 ...
 *******************************************************************************/
#ifndef OMR_RV_TREE_EVALUATOR_INCL
#define OMR_RV_TREE_EVALUATOR_INCL
...
public:
	...
	static TR::Register *iumulEvaluator(TR::Node *node, TR::CodeGenerator *cg);
	...
	static TR::Register *callIfEvaluator(TR::Node *node, TR::CodeGenerator *cg);
	...
	static TR::Register *iuconstEvaluator(TR::Node *node, TR::CodeGenerator *cg);
	static TR::Register *luconstEvaluator(TR::Node *node, TR::CodeGenerator *cg);
	static TR::Register *buconstEvaluator(TR::Node *node, TR::CodeGenerator *cg);
	...
	static TR::Register *buaddEvaluator(TR::Node *node, TR::CodeGenerator *cg);
	...
	static TR::Register *trtLookupEvaluator(TR::Node *node, TR::CodeGenerator *cg);
	...
	static TR::Register *RetEvaluator(TR::Node *node, TR::CodeGenerator *cg);
	...
	static TR::Register *bitOpMemNDEvaluator(TR::Node *node, TR::CodeGenerator *cg);
	...
	static TR::Register *MergeNewEvaluator(TR::Node *node, TR::CodeGenerator *cg);
	...
	static TR::Register *trtSimpleEvaluator(TR::Node *node, TR::CodeGenerator *cg);
...
#endif //OMR_RV_TREE_EVALUATOR_INCL
